...
const texts = ['React', 'TypeScript', 'NodeJS', 'Express', 'Tailwind css',
    'JWT', 'Figma', 'Git', 'Heroku', 'SSR', 'Bootstrap', 'JavaScript', 'Material-ua',
    'Redux', 'REST', 'SCSS', 'TDD', 'Jest', 'Webpack', 'JSON', 'BEM', 'Ant-design'
]
